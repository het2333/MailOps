...
export function ConnectionBanner({ integration, onSync }: { integration?: IntegrationStatus; onSync: () => Promise<void> }) {
  ...
  if (integration.mode === "demo") return <div className="connection-banner demo-connection"><span className="connection-dot connected" /><b>Demo workspace ready</b><span>Email delivery and Calendar writes are simulated safely. Workflow and approvals use the real backend.</span></div>;
