...
> This repository currently provides a local safe demo only. It is not deployed to a public server.
...
The safe demo runs locally. Each browser session can recreate catalog scenarios with one click.
